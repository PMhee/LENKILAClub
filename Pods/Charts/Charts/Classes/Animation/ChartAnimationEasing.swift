...
<<<<<<< HEAD:Pods/Charts/Charts/Classes/Animation/ChartAnimationEasing.swift
        return -0.5 * ((position-1) * (position - 2.0) - 1.0)
=======
        
        return -0.5 * ((position - 1.0) * (position - 3.0) - 1.0)
>>>>>>> c6b0cd0431b1e43c905dfbbe8f6ec1b399d78ed0:Pods/Charts/Source/Charts/Animation/ChartAnimationEasing.swift
    }
